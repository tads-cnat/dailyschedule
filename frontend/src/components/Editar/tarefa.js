...
const Tarefa = () => {
	...
	return (
		<div>
						...
						<div className="crono-priv-editar">
							<div className="info">
								...
								<input
									...
									value={titulo_tarefa || tarefas.titulo}
								/>
								<br />
							</div>
							<div className="info">
								...
								<input
									...
									name="assunto"
									id="assunto"
									onChange={(e) => setAssuntoTarefa(e.target.value)}
									value={assunto_tarefa || tarefas.assunto}
								/>
								<br />
							</div>
							<div className="info">
								...
								<input
									...
									value={descricao_tarefa || tarefas.descricao}
								/>
								<br />
							</div>
							<div className="info">
			...
			<section className="editar_visualizar"></section>
		</div>
	);
};

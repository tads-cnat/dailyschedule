				...
				<div className="bene">
					<div className="beneficio">
						<div className="bnfc">
							...
							<p>
								Com os assuntos mapeados e organizados com horário e dentro da sua
								rotina, você vai perceber que o cronograma de estudos tornará mais
								fácil assimilar as informações, já que terá dias específicos para
								cada assunto. Além de contribuir, principalmente, para a melhorar
								sua concentração.
							</p>
						</div>
						<div className="bnfc">
							...
							<p>
								...
								resultados melhores nas provas, automaticamente, vai se sentir
								mais confiante. É essa confiança que precisamos para te ajudar a
						...
						<div className="bnfc">
							...
							<p>
								...
								com seu aprendizado de maneira organizada já que você pode olhar
